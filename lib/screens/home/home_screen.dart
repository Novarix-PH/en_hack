            ...
            child: Column(
              children: [
                ...
                const _CardGrowthTrack(
                  ...
                  listSubText: ["Identity", "Brand Message", "Visual Design", "aesthetic"],
                ),
                const _CardGrowthTrack(
                  title: 'PRODUCT',
                  imageUri: "assets/images/card_images/card_image_pic_2.png",
                  listSubText: ["Enhancement", "Launching", "Brand Integration"],
                ),
                const _CardGrowthTrack(
                  title: 'MARKETING',
                  imageUri: "assets/images/card_images/card_image_pic_3.png",
                  listSubText: ["Brand Positioning", "Campaigns", "Assessment"],
                ),
                const _CardGrowthTrack(
                  title: 'EXPANSION',
...
class _CardGrowthTrack extends StatelessWidget {
  ...
  const _CardGrowthTrack({required this.title, required this.imageUri, this.isMostRecommended, this.listSubText, this.isLocked,});
